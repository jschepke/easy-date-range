import { RangeOpts } from "../dateRange";
...
const dateRangeOptionsKeysMap: PropertiesMap<RangeOpts> = {
	endOffset: "endOffset",
	refDate: "refDate",
 ...
 */
export function validateRangeOpts(value: unknown): void {
	...
	const { refDate, refWeekday, startOffset, endOffset } = value as RangeOpts;
