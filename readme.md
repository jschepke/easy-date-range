...
- [`getNext`](#getnext) and [`getPrevious`](#getprevious) methods enable easy shifting of any range passed into them.
...
| refDate     | [DateTime](https://moment.github.io/luxon/api-docs/index.html#datetime) | current day    | The reference date for current generated range.                                    |
